...
export default function EmployeeSetup() {
  ...
  const [employeeInfo, setEmployeeInfo] = useState<{first_name: string, last_name: string} | null>(null);
      ...
      <div className="w-full max-w-md px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Merhaba {employeeInfo?.first_name} {employeeInfo?.last_name}
          </p>
        </div>
        ...
        <Card className="w-full shadow-lg border-0">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              PDKS sistemine giriş yapmak için güvenli bir şifre belirleyin
            </CardDescription>
          </CardHeader>
          <CardContent>
