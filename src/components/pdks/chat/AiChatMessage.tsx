                ...
                <PopoverContent className="w-80">
                  <div className="space-y-2">
                    ...
                    <div className="text-xs space-y-1">
                      <div>Departman Filtresi: <span className="font-mono bg-muted-foreground/20 px-1 rounded">{data[0]?.department || 'Belirtilmedi'}</span></div>
                      <div>Kayıt Sayısı: <span className="font-mono bg-muted-foreground/20 px-1 rounded">{data.length}</span></div>
                    </div>
                  </div>
                </PopoverContent>
              </Popover>
